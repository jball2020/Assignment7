/***************************************************************
	Class: 		game
	File: 		game.cc
	Author: 	Michael Main, Walter Savitch, Edited by Jordan Ball
	Date: 		11/28/2017
	Assignment: Project 6
	Purpose:	Class that defines the operations a two player game
...
// this function.	
	...
	int value = 0;//evaluate( ); // Evaluate based on move that was just made.
	...
	//this checks to see if the computer has to moves
	if(moves.empty()){
		display_message("Computer has no moves! It's turn was passed!\n");
		best_move = "!1@2#3";
	}
	//assert(!moves.empty( ));
